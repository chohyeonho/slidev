import{p as U}from"./chunk-WASTHULE-DmnYyW96.js";import{p as q}from"./treemap-KZPCXAKY-L5K4MMMF-8q8cSgLW.js";import{g as H,s as Q,a as V,b as Z,t as j,q as J,_ as s,l as w,c as K,G as X,aO as Y,aP as ee,aQ as G,aR as te,e as ae,A as re,aS as ie,H as se}from"./md-COav__dv.js";import"./chunk-MFRUYFWM-Bq49G76S.js";import"./monaco/bundled-types-CIFvryCh.js";import"./modules/shiki-BwyUinQh.js";import"./modules/vue-CDU5Vdpg.js";import"./modules/file-saver-C8QSpN-3.js";import"./lz-string-si4yBCUE.js";import"./index-cmBnzWNJ.js";import"./slidev/default-CJibrU2E.js";import"./slidev/context-Duvj1PPn.js";var oe=se.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,le=structuredClone(oe),ne=s(()=>structuredClone(le),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,re()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),O={getConfig:ne,clear:ce,setDiagramTitle:J,getDiagramTitle:j,setAccTitle:Z,getAccTitle:V,setAccDescription:Q,getAccDescription:H,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},fe=s((e,a)=>{U(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),me={parse:s(async e=>{const a=await q("pie",e);w.debug(a),fe(a,O)},"parse")},he=s(e=>`
  .pieCircle{
